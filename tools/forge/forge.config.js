...
module.exports = {
  ...
  packagerConfig: {
    ...
    asar: true,
    // Set executable name
    executableName: "electron-react-sass-webpack",
    // Set application copyright
    appCopyright: "Copyright (C) 2022 IShungite",
  },
  // Forge Makers
  makers: [
    {
      ...
      config: {
        name: "electron-react-sass-webpack",
      },
    },
    {
  ...
  plugins: [
    [
      ...
      "@electron-forge/plugin-webpack",
      {
        ...
        mainConfig: path.join(rootDir, "tools/webpack/webpack.main.config.js"),
        // Renderer process webpack configuration
        renderer: {
          // Configuration file path
          config: path.join(rootDir, "tools/webpack/webpack.renderer.config.js"),
